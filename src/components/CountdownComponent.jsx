...
const CountdownComponent = ({ onComplete }) => {
  ...
  return <>
    <div className="flex flex-col items-center justify-center min-h-screen text-center relative">
      ...
      {/* Main countdown box */}
      <motion.div
        className="relative p-12 rounded-3xl w-full sm:w-auto bg-gradient-romantic shadow-glow backdrop-blur-sm
        border border-romantic-light/30"
      ...
      >
        ...
        {/* Glowing Effect */}
        <motion.div
          className="absolute inset-0 rounded-3xl bg-gradient-glow"
        ...
        >
          <motion.h1 
            className="text-4xl sm:text-6xl font-bold text-white mb-4 font-mono tracking-wider"
            animate={{
              textShadow: [
          ...
          >Get ready for something special ✨</motion.a>
        </motion.div>
